...
ARR_MODULE = [
    ...
    },
    {
        ...
        themes: [
            ...
            [root+'function/announcement',              emoji.star+'Объявление'],
            [root+'function/arrow',                     emoji.star+'Стрелочные функции (ES6)'],
            [root+'function/parameters',                emoji.star+'Параметры функции (ES6)'],

            [root+'function/arguments',                 'Arguments'],
