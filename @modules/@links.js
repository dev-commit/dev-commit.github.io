...
const ARR_LINKS = [
    ...
    { page: 'js-function',             theme: 'js',    title: search+'Function' },
    ...
    { page: 'web-components',          theme: 'secondary',    title: search+'WebComponents' },
    null,
    ...
    { page: 'git-managers',            theme: 'tech',  title: search+'GitHub ...' },
