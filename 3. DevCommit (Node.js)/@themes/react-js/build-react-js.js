...
ARR_MODULE = [
    {
        ...
        themes: [
            ...
            [root+'main/handlers-name',    emoji.star+'Название обработчиков'],
            [root+'main/version',          'Версии'],
        ]
    },
    {
        title: 'Реконсиляция',
        accent: true,
        themes: [
            [root+'reconciler/virtual-dom',       emoji.star+'Virtual DOM (Общее)'],
            [root+'reconciler/virtual-dom-react', emoji.star+'Virtual DOM (React)'],
