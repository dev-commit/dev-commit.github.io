...
function getLink(root, item, updated = false) {
  ...
  switch (item) {
    ...
    case "install":
      return [
        root + "main/install",
        emoji.settings + "Установка и настройка",
        false,
        checkUp(),
      ];
    case "use":
...
function setTheme(tag, arr) {
  ...
  switch (tag) {
    case 1:
      ...
      break;
    case 2:
      resultTag = "u-menu-border";
      break;
    case 3:
      resultTag = "u-menu-accent";
      break;
    case 4:
      resultTag = "u-menu-unactive";
      break;
    case 5:
      resultTag = "u-menu-outline";
      break;
    case 6:
      resultTag = "u-menu-gray";
      break;
    case 7:
      resultTag = "u-menu-error";
      break;
    default:
      resultTag = "u-menu";
  }
