...
var arrReactApi = [
    ...
    ['react-api', 'optimization', 'react-pure-component',    emoji.chevron+setTheme(4, ['React.PureComponent'])],
    ['react-api', 'optimization', 'react-memo',              emoji.chevron+setTheme(4, ['React.memo'])],
    ['react-api', 'optimization', 'react-lazy',              emoji.chevron+setTheme(4, ['React.lazy', 'React.Suspense'])],
...
var arrReactHooks = [
    ...
    ['react-hooks', 'hooks', 'use-imperative-handle', emoji.baseball+setTheme(4, ['useImperativeHandle'])],
    ['react-hooks', 'hooks', 'use-layout-effect',     emoji.baseball+setTheme(4, ['useLayoutEffect'])],
    ['react-hooks', 'hooks', 'use-debug-value',       emoji.baseball+setTheme(4, ['useDebugValue'])],
