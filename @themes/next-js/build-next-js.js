...
ARR_MODULE = [
  ...
  {
    title: "Настройки",
    themes: [[root + "settings/env", setTheme(5, ["ENV-переменные"])]],
  },
  {
    title: "TypeScript",
    themes: [
  ...
  },
  {
    ...
    themes: [
      ...
      [
        root + "fetch/getInitialProps",
        setTheme(1, ["getInitialProps"]),
        false,
        "check",
      ],
      [
        root + "fetch/getServerSideProps",
        setTheme(1, ["getServerSideProps"]),
        false,
        "check",
      ],
      [
        root + "fetch/getStaticProps",
        setTheme(1, ["getStaticProps"]),
        false,
        "check",
      ],
    ],
