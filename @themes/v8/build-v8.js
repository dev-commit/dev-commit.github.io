...
ARR_MODULE = [
  {
    ...
    themes: [
      [
        root + "rendering/critical-rendering-path",
        emoji.fire + "Critical Rendering Path",
      ],
      [root + "rendering/repaint-and-reflow", emoji.fire + "Repaint & Reflow"],
      [
        root + "rendering/requestAnimationFrame",
        setTheme(1, ["requestAnimationFrame"]),
      ],
    ],
  },
  {
    ...
    themes: [
      ...
      [
        root + "optimization/website-loading",
        emoji.theory + "Загрузка веб-страницы",
      ],
