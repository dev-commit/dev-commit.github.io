...
ARR_MODULE = [
  {
    ...
    themes: [
      ...
      [
        root + "hooks/useSyncExternalStore",
        setTheme(1, ["useSyncExternalStore"]),
      ],
      [root + "hooks/useDeferredValue", setTheme(1, ["useDeferredValue"])],
      [
        root + "hooks/useImperativeHandle",
        setTheme(1, ["useImperativeHandle"]),
      ],
  ...
  },
  {
    ...
    themes: [
      ...
      [
        root + "custom-hooks/useDidUpdateEffect",
        setTheme(5, ["useDidUpdateEffect"]),
      ],
      ...
      [
        root + "custom-hooks/useFirstMountState",
        setTheme(5, ["useFirstMountState"]),
      ],
    ],
  },
];
